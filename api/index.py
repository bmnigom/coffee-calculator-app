...
RECETAS = [
    ...
    # --- KALITA WAVE ---
    {
        ...
        "temperature_c": 92,
        "grind": {
            "description": "Media-gruesa (como arena)",
            "timemore_x_lite_clicks": None,
            "m3_bomber_r3_pro_clicks": None,
        },
        "pours": [
            {
                ...
                "start_time": "0:00",
                "target_weight_percentage": 0.20,
                "description": "Verter 60g de agua suavemente. Esperar 45s.",
            },
            {
                "step": 2,
                "name": "Vertido Principal",
                "start_time": "0:45",
                "target_weight_percentage": 0.50,
                "description": "Verter en espiral hasta los 150g. Mantener nivel de agua.",
            },
            {
                "step": 3,
                "name": "Cierre",
                "start_time": "1:30",
                "target_weight_percentage": 1.0,
                "description": "Completar hasta los 300g. Dejar drenar.",
            },
        ],
    },
    # --- HARIO PEGASUS ---
        ...
        "pours": [
            {
                ...
                "start_time": "0:00",
                "target_weight_percentage": 0.20,
                "description": "Vertido rápido de 50g. Esperar 30s.",
            },
            {
                "step": 2,
                ...
                "start_time": "0:30",
                "target_weight_percentage": 0.60,
                "description": "Llenar la tolva hasta 150g en círculos constantes.",
            },
            {
                "step": 3,
                "name": "Cierre",
                "start_time": "1:15",
                "target_weight_percentage": 1.0,
                "description": "Completar hasta 250g vertiendo en el centro.",
            },
        ],
    },
]
